...
function Sidebar() {
  ...
  return (
    <div className='space-y-2 min-w-max max-w-lg '>
        {/* Top */}
        <div className='bg-white dark:bg-[#1D2226] rounded-lg overflow-hidden relative flex flex-col items-center text-center border 
        border-gray-300 dark:border-none'>
            ...
            <div className='mt-5 py-4 space-x-0.5'>
                ...
                <p className="text-black/100 dark:text-white/75 text-sm">{session?.user?.email}</p>
            </div>
